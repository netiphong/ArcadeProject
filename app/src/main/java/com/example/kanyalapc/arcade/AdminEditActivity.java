...
public class AdminEditActivity extends AppCompatActivity {
    ...
    TextView txtInfo;
    EditText imageName,details,pointt,download,packg,uid;
    ...
    public void Editgame(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String FinalData = imageProcessClass.ImageHttpRequest("http://"+ConfigIP.IP+"/editGame.php", HashMapParams);
   ...
   public void checkstatus() {
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http:/"+ConfigIP.IP+"/adminEdit.php").newBuilder();
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    pointt.setText(jsonObject.getString("usepoint"));
                                    download.setText(jsonObject.getString("link"));
                                    packg.setText(jsonObject.getString("package"));
    ...
    public void deldb(){
        ...
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http:/"+ConfigIP.IP+"/deleteGame.php").newBuilder();
            urlBuilder.addQueryParameter("UID",uid.getText().toString());
