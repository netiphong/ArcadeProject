...
public class RegisterActivity extends AppCompatActivity {
    private EditText editName,editPassword,editEmail,editConPassword;
    private Button Btn_insert,btn_back;
    private TextView txtInfo,chk1,chk2,chk3,chk4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chk4=(TextView)findViewById(R.id.chk4);
        ...
        Btn_insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(editEmail.getText().toString().matches(emailPattern)){
                    chk4.setText("Correct");
                }
                else {
                    chk4.setText("Enter Email Pattern");
                }
                ...
                try {
                    ...
                    if(editEmail.getText().toString().matches(emailPattern)&& editPassword.getText().toString().matches(passPattern)&&editName.getText().toString().matches(userPattern)&& editPassword.getText().toString().matches(editConPassword.getText().toString())){
                        ...
                        urlBuilder.addQueryParameter("Email", editEmail.getText().toString());
                        urlBuilder.addQueryParameter("point", "0");
        ...
        btnRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://192.168.2.249/test/read.php").newBuilder();
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://192.168.2.249/test/update.php").newBuilder();
                    urlBuilder.addQueryParameter("PID", txtPID.getText().toString());
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://192.168.2.249/test/delete.php").newBuilder();
                    urlBuilder.addQueryParameter("PID", txtPID.getText().toString());
