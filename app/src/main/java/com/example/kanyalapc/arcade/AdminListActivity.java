    ...
    */
    public class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            final AdminListActivity.Teacher link= (AdminListActivity.Teacher) this.getItem(i);
            final AdminListActivity.Teacher usepoint= (AdminListActivity.Teacher) this.getItem(i);


            final AdminListActivity.Teacher packagee=(AdminListActivity.Teacher) this.getItem(i);
    ...
    public class DataRetriever {
        ...
        private final String PHP_MYSQL_SITE_URL="http://"+ConfigIP.IP+"/readAdminGameList.php";
        //INSTANCE FIELDS
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                for(int i=0;i<response.length();i++)
                                {
                                    ...
                                    String usepoint =jo.getString("adname");
                                    String link =jo.getString("link");

                                    teacher=new AdminListActivity.Teacher(name,description,"http://"+ConfigIP.IP+""+imageURL,packagee,link,usepoint,id);
